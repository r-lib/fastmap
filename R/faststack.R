...
#'     `missing_default` that `stack()` was created with.
#'   }
#'   \item{\code{peek(missing = missing_default)}}{
#'     Return the top object on the stack, but do not remove it from the stack.
#'     If the stack is empty, this will return `missing`, which defaults to the
#'     value of `missing_default` that `stack()` was created with.
#'   }
#'   \item{\code{reset()}}{
